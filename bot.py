...
&b&uБронирование:&u&b
Бронирование состоит из 5-и этапов:
...
&iВ связи с тем, что телеграм блокируется в России, могут возникать неполадки со связью, поэтому не спешите жать на кнопки по сто раз, возможно, нужно будет просто подождать.&i
'''
